...
especially for intermediate+ level developers/engineers, it solves the question that percolates everyone's head at some point or another: "if me and my friends got together to build something, how far and how fast could we go?" and i'll tell you now that you'd be really shocked at what you and your friends could accomplish. i'll tell you now that our entire team was absolutely **NOT** losing sleep over the hackathon, in the absolute best case we'd show up at 9am and leave around 6-7pm, work a slight amount from home and sleep a full 8 hours or more, this is not bringing up the number of times we all took breaks to shoot the shit, arrive hours late, two of our group members went to two SEPARATE weddings in the middle of the hackathon. so, in short, you don't need to go absolutely balls to the wall to have fun and make a semi-competitive project.

## you gain a fresh prespective

when you're in a hackathon, you're typically doing challenges in certain categories, if you haven't already asked other groups how they're solving similar problems, you really should! most groups love sharing what they're working on and how, regardless of the whole competition aspect, and most people are too nice to withold information from you. worst case, you can take a look at other teams' repos to see how they handled similar prompts as you. also, you get to measure what you did well and where you misprioritized elsewhere.
...
btw if you want to see our submission:
 ...
 - here's the actual [submission](https://www.spaceappschallenge.org/nasa-space-apps-2024/find-a-team/reesaholics/?tab=project)
 - here are the [slides](https://abbiedewhirst.github.io/NASA-Landsat/satelleyes_slides.pdf) detailing a high level overview of the app
 - here's the [prod site](https://nasa.matp101.com/) (eventually this link will die)
 - here's the [repo](https://github.com/AbbieDewhirst/NASA-Landsat)
 - here's the [wiki](https://github.com/AbbieDewhirst/NASA-Landsat/wiki) (how to use the app and what to expect)
